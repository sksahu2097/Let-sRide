<?php
    ...
    pg_query($connect,"delete from customerdetails where userid='".$userid."'");
    pg_query($connect,"insert into customerdetails values('$userid','$area','$dist','$state','$landmark','$pincode','$darea','$ddist','$dstate','$dlandmark','$dpincode')");
